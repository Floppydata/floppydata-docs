...
<CardGroup cols={2}>
  <Card title="Account balances reference" icon="terminal" href="/api-reference/v2/endpoint/account-balances">
    Full account balance schema.
  </Card>

  <Card title="Account usage reference" icon="terminal" href="/api-reference/v2/endpoint/account-usage">
    Full account usage schema.
  </Card>
</CardGroup>
