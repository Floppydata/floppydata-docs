...
You do not switch hosts for different countries or proxy types. Instead, all routing is controlled by Smart Parameters passed in your credentials.
...
This tells Floppydata:

- use residential IPs
- route through the United States
- keep the same IP for this session

Every request with this configuration will follow the same routing logic.

Why this model is different

Traditional proxies:

- you select IPs manually
- you manage rotation
- you maintain proxy lists
...
This makes integrations simpler and reduces operational overhead.
