...
Static IPs are a separate product. For static IPs, use the credentials returned by the [Static IP List](/api-reference/endpoint/static-list) endpoint instead of adding a Smart Parameter type.
