...
Static proxies are a separate product. For static proxies, use the credentials returned by the [Static Proxy API](/api-reference/v2/endpoint/static-proxies) instead of adding a Smart Parameter type.
