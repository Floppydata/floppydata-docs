...
<ParamField path="state" type="string">
  US state targeting (abbreviation or full name)

  **Examples:**

  - `state-CA` or `state-California`
  - `state-NY` or `state-New_York`

  **Example:** `user123-res-country-US-state-TX`
</ParamField>
...
<AccordionGroup>
  ...
  <Accordion title="What if a city is unavailable?" icon="question">
  </Accordion>
</AccordionGroup>